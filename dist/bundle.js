  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('/api/employees').then(function (result) {
        ...
        var managers = employees.filter(function (employee) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h1',
            null,
            'Acme Employees and Managers REACT'
          ),
          _react2.default.createElement(_reactRouterDom.Route, { component: function component(props) {
              return _react2.default.createElement(_Nav2.default, { location: props.location, employees: employees, managers: managers });
            } }),
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', render: Home }),
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/employees', render: function render() {
              return _react2.default.createElement(_Employees2.default, { employees: employees });
            } }),
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/managers', render: function render() {
    ...
    managers.map(function (manager) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          manager.manages.map(function (managed) {
            return _react2.default.createElement(
              'li',
              { key: managed.id },
              managed.name
